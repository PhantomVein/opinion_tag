...
class Configurable(object):
    ...
    @property
    def pretrained_char_embeddings_file(self):
        return self._config.get('Data', 'pretrained_char_embeddings_file')

    @property
    def pretrained_bichar_embeddings_file(self):
        return self._config.get('Data', 'pretrained_bichar_embeddings_file')
    ...
    @property
    def max_train_inst_len(self):
        return self._config.getint('Data', 'max_train_inst_len')
